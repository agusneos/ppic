...
<table id="grid-inquiry_rekap_barang_detail"
...
<script type="text/javascript">    
    $('#grid-inquiry_rekap_barang_detail').datagrid({
        url             : '<?php echo site_url('inquiry/rekap/showRekapBarangDetail'); ?>?grid=true&rekap_item='+rowDetail.m_item_id+'&rekap_proses='+rekap_proses+'&rekap_tgl_from='+rekap_tgl_from+'&rekap_tgl_to='+rekap_tgl_to}
    );
</script>

<!-- End of file v_rekap_barang_detail.php -->
<!-- Location: ./views/inquiry/rekap/v_rekap_barang_detail.php -->
